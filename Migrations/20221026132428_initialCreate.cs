    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<string>(type: "varchar(250)", maxLength: 250, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StatusFurniture = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Furniture_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_Furniture_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Furniture_EmployeeId",
                table: "Furniture",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Furniture_UserId",
                table: "Furniture",
                column: "UserId");
        }
